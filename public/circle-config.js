window.CIRCLE_CONFIG = {
  // Public App ID from Circle Console → Wallets → User Controlled → Configurator (production environment).
  appId: 'f431df4a-e673-508b-894c-1aad8fa2fc2b',
  // The sandbox App ID, used when the server runs on the test network (CIRCLE_BLOCKCHAIN=ARC-TESTNET).
  testnetAppId: '2ec119fc-7953-5335-8d33-b8a1519c6435',
